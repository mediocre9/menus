# Menus
Menus is a DOS based graphics foundational class that is built upon vain-engine library. It can be used to create simple GUI applications. It offers various GUI components from tear-down menus to window frames etc.
